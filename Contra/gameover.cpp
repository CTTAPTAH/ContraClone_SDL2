...
void GameOverRender(SDL_Rect& cursor)
{
	...
	TextRender(font.despair, text.game_over, text.rect_game_over, "GAME OVER", text.large_size, color_white);
	...
	List& boss_bullet_list, Boss& boss)
{
	...
	if (play_state == PLAY_BOSS) BossRender(boss);
